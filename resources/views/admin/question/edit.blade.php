        ...
        <div class="card-body">
            ...
            <div class="form-group mt-2">
                ...
                <select name="correct_answer" class="form-control">
                    ...
                    <option @if($question->correct_answer==='answer2') selected @endif value="answer4">2. Cevap</option>
                    <option @if($question->correct_answer==='answer3') selected @endif value="answer3">3. Cevap</option>
                    <option @if($question->correct_answer==='answer4') selected @endif value="answer2">4. Cevap</option>
