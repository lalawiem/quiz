<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Hamburger -->
            <div class="mr-2 flex items-center sm:hidden m-auto">

            <x-jet-dropdown-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="text-left">
                {{ __('Ana Sayfa') }}
            </x-jet-dropdown-link>

            <x-jet-dropdown-link href="{{ route('duyurular.index') }}" :active="request()->routeIs('dashboard')">
                {{ __('Duyurular') }}
            </x-jet-dropdown-link>
            </div>

        <div class="pt-2 pb-2 mt-1 space-y-1 text-center">
                <button @click="open = ! open"
                    class="inline-flex items-rihgt justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition">
